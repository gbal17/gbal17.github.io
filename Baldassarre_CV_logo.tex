...
\raggedleft\includegraphics[width=2.3cm]{logo_round_small.jpg}
\end{minipage}
...
\item Design and delivery of trainings on ``Geospatial Tools for Mangrove Monitoring in The Gambia'' \href{https://gambia-geolab.netlify.app/pf2025/}{(visit)} and ``Using SEPAL, Google Earth Engine and Collect Earth Online to produce a Land Cover Map of Gambia (2023)'' \href{https://gambia-geolab.netlify.app/roots2024/}{(visit)}
\end{itemize}
